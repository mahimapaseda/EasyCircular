...
const panelClass = "rounded-2xl border border-white/10 bg-black/30 backdrop-blur-xl overflow-hidden";
    ...
    return (
      <div className={`${panelClass} p-6`}>
        <div className="flex flex-col items-center gap-5 text-center">
          <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-cyan-400/20 to-blue-600/20 border border-cyan-400/20">
          ...
          <button
            type="button"
            onClick={onExtract}
            className="inline-flex items-center gap-2 rounded-xl bg-white px-6 py-2.5 text-sm font-bold text-slate-900 shadow-md transition hover:scale-[1.02]"
          >
  ...
  return (
    <div className={panelClass}>
      <div className="flex items-center justify-between gap-3 border-b border-white/10 px-5 py-3.5">
        ...
        >
          <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg border border-white/10 bg-white/5 text-cyan-400">
            <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <div className="flex shrink-0 items-center gap-2">
          <button
            type="button"
            onClick={onExtract}
            className="hidden rounded-lg px-2 py-1 text-xs font-medium text-slate-400 transition hover:bg-white/10 hover:text-white sm:inline-flex"
          >
            Re-extract
          </button>
          <button
        ...
        <div>
          ...
          <div className="p-5">
            {textView === "highlights" && hasEntities ? (
              <div className="max-h-[320px] overflow-y-auto rounded-xl border border-white/10 bg-black/20 p-4 scrollbar-thin">
              ...
              <textarea
                ...
                className="min-h-[240px] w-full resize-y rounded-xl border border-white/15 bg-white/5 px-4 py-3 font-mono text-[13px] leading-relaxed text-slate-200 outline-none placeholder:text-slate-500 focus:border-cyan-400/40 focus:ring-2 focus:ring-cyan-400/20"
              />
            )}
