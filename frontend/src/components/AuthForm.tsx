  ...
  return (
    <div>
      ...
      <button
        ...
        className="flex w-full items-center justify-center gap-3 rounded-lg border border-slate-300 bg-white py-3 text-sm font-medium text-slate-700 opacity-60 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-300"
      >
        <GoogleIcon />
        Google
      </button>
      ...
      <p className="mt-8 text-center text-sm text-slate-600 dark:text-slate-400">
        {isSignUp ? (
          <>
            ...
            <Link href="/sign-in" className="font-semibold text-brand-600 hover:underline dark:text-brand-400">
              Sign in
            </Link>
          </>
        ) : (
          <>
            ...
            <Link href="/sign-up" className="font-semibold text-brand-600 hover:underline dark:text-brand-400">
              Sign up
            </Link>
          </>
        )}
